...
const App = () => {
  ...
  return (
    <div className="min-h-screen  bg-no-repeat bg-contain  bg-slate-100 dark:bg-gray-900 transition-all duration-1000 bg-[url('./assets/images/bg-mobile-light.jpg')] dark:bg-[url('./assets/images/bg-mobile-dark.jpg')] md:bg-[url('./assets/images/bg-desktop-light.jpg')] md:dark:bg-[url('./assets/images/bg-desktop-dark.jpg')]">
      <Header />
